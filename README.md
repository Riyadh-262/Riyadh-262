...
Machine learning system for predicting loan approvals using ANN and Random Forest.

**Technologies:** Python, TensorFlow, Scikit-learn, SHAP

### 🏏 EWU Cricket Tournament
Database management system for EWU Cricket Tournament data.

**Technologies:** Oracle SQL, Oracle APEX

### 🏠 Fire Detection and Monitoring System
IoT-Based Real-Time Fire Detection and Monitoring System using ESP32.
